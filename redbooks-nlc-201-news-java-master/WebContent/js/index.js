...
$(document).ready(function() {
	...
	function addFeedbackClassification(node){ 	  
  		var selectHTML = "<div class=\"results--item-text\">Sugerir otra clasificación : ";
  		selectHTML+="<select id=\"class\">";
  		var choices = ["CNR", "Retenida","Error de Lectura","Problema en Clave","Doble Cobro","No indica Motivo", "Otros"];
  		var valChoices = ["CNR", "Retenida","Error de Lectura","Problema en Clave","Doble Cobro","No indica Motivo", "Otros"];
